...
Post.getInitialProps = async ({ query }) => {
  ...
  if (lslug[1] === "today" || lslug[1] === "undefined") {
    const res = await fetch(
      `http://www.goalserve.com/getfeed/40e962b3c2a941d6a61008d85e49316a/soccernew/home?json=1`
    );
    ...
    const res = await fetch(
      `http://www.goalserve.com/getfeed/40e962b3c2a941d6a61008d85e49316a/soccernew/${lslug[1]}?json=1`
    );
    const data = await res.json();
