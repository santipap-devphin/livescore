...
const TableBattle = dynamic(() =>
  import("../../../shared/commons/TableBattle")
);
const TableBattleMobile = dynamic(() =>
  import("../../../shared/commons/TableBattleMobile")
);
...
export default class Homefilter extends Component {
  static async getInitialProps({ query }) {
    ...
    const res = await fetch(
      `https://www.goalserve.com/getfeed/40e962b3c2a941d6a61008d85e49316a/soccernew/${id}?json=1`
    );
    ...
    return (
      <Layout className="px-0 px-md-3" standings={this.props.list}>
        ...
        <div className="d-none d-md-block">
          <img
            className="mb-4 img-fluid w-100 h-70px"
            src="/assets/ads/ads630x70.png"
            alt=""
          />
          <img
            className="mb-4 img-fluid w-100 h-70px"
